...
DARK_POOLS = {"bass": ["bass_dark", "bass_industrial", "bass_sub", "bass_growl", "bass_reese",
                       "bass_fm", "bass_wobble", "bass_808", "bass_ms20", "bass_sh101",
                       "bass_dx7"],
              "lead": ["lead_dark", "lead_industrial", "lead_scream", "lead_growl", "lead_glide",
                       "lead_ms20", "lead_minimoog", "lead_cs80", "lead_piano_atmos"],
              "pad": ["pad_dark", "pad_warm", "pad_choir", "pad_strings", "pad_cs80", "pad_obx",
                      "pad_piano_atmos"],
              "arp": ["arp_dark", "arp_stab", "arp_fm", "arp_square", "arp_sh101", "arp_dx7",
                      "arp_piano_atmos"],
              "ambient": ["ambient_dark", "ambient_deep", "ambient_wind", "ambient_choir"],
              "drums": ["drums_dark", "drums_industrial", "drums_hall", "drums_lofi",
                        "drums_breaks"]}
BRIGHT_POOLS = {"bass": ["bass_moog", "bass_sub", "bass_pulse", "bass_reese", "bass_square",
                         "bass_pluck", "bass_fm", "bass_808", "bass_prophet", "bass_sh101",
                         "bass_dx7"],
                "lead": ["lead_saw", "lead_pulse", "lead_industrial", "lead_brass", "lead_hollow",
                         "lead_glide", "lead_organ", "lead_prophet", "lead_obx", "lead_cs80",
                         "lead_minimoog", "lead_piano_atmos"],
                "pad": ["pad_juno", "pad_strings", "pad_glass", "pad_shimmer", "pad_warm",
                        "pad_prophet", "pad_jupiter", "pad_obx", "pad_cs80", "pad_polysix",
                        "pad_piano_atmos"],
                "arp": ["arp_pluck", "arp_saw", "arp_square", "arp_glass", "arp_fm",
                        "arp_jupiter", "arp_sh101", "arp_dx7", "arp_piano_atmos"],
                "ambient": ["ambient_drone", "ambient_shimmer", "ambient_rain", "ambient_choir",
                            "ambient_wind"],
                "drums": ["drums_808", "drums_linn", "drums_tight", "drums_hall",
                          "drums_acoustic", "drums_soft80", "drums_breaks"]}
...
CYBER_POOLS = {"bass": ["bass_industrial", "bass_growl", "bass_reese", "bass_industrial",
                        "bass_wobble", "bass_fm", "bass_acid", "bass_ms20"],
               "lead": ["lead_industrial", "lead_scream", "lead_dark", "lead_growl", "lead_ms20"],
...
DRIVE_POOLS = {"bass": ["bass_moog", "bass_sub", "bass_pulse", "bass_reese", "bass_square",
                        "bass_fm", "bass_acid", "bass_sh101", "bass_prophet"],
               "lead": ["lead_saw", "lead_pulse", "lead_scream", "lead_brass", "lead_glide",
                        "lead_obx", "lead_prophet"],
               "pad": ["pad_juno", "pad_strings", "pad_shimmer", "pad_jupiter", "pad_obx"],
               "arp": ["arp_saw", "arp_pluck", "arp_stab", "arp_square", "arp_jupiter",
                       "arp_sh101"],
...
MOODS: dict[str, Mood] = {
    ...
    "dreamy": Mood("dreamy", 108, 0.5, 0.75, 0.4, 1.0, 0.35,
                  ...
                  tick_prob=0.6,
                  snap_prob=0.4, ride_prob=0.3, shaker_prob=0.3),
    ...
    "chill": Mood("chill", 90, 0.4, 0.6, 0.3, 0.9, 0.0,
                  ...
                  tick_prob=0.8,
                  snap_prob=0.8, ride_prob=0.4, shaker_prob=0.6),
    "retro": Mood("retro", 110, 0.6, 0.8, 0.45, 1.1, 0.5,
                  ...
                  tick_prob=0.8,
                  snap_prob=0.35, ride_prob=0.5, shaker_prob=0.2),
